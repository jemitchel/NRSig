...
# Opens the NR -> target probe data source
# Already removed NRs with < 15 target genes
...
CalcEnrich <- function(test_samples, cross_probes) {
  ...
  # Removes probes from ss data and target source if using xenograft data
